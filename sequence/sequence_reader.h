...
class FastaReader : public SequenceReader {
  public:
    FastaReader() {}
    explicit FastaReader(std::istream &is, bool is_own = false) : SequenceReader(is, false) {}
...
class FastqReader : public SequenceReader {
  public:
    explicit FastqReader(std::istream &is, bool is_own = false) : SequenceReader(is, false) {}
