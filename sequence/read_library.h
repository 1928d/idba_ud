...
class ShortReadLibrary {
  public:
    ...
    ShortSequence &operator[](int64_t index) { return reads_[index]; }

    const ShortSequence &operator[](int64_t index) const { return reads_[index]; }
...
class LongReadLibrary {
  public:
    ...
    Sequence &operator[](int64_t index) { return reads_[index]; }

    const Sequence &operator[](int64_t index) const { return reads_[index]; }
