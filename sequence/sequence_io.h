...
uint64_t WriteSequence(const std::string &filename, const std::deque<Sequence> &sequences,
                       const std::string &prefix = "");
uint64_t WriteSequence(FastaWriter &writer, const std::deque<Sequence> &sequences, const std::string &prefix = "");

uint64_t WriteSequence(const std::string &filename, const std::deque<ShortSequence> &sequences,
                       const std::string &prefix = "");
