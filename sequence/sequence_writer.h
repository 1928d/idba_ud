...
class FastaWriter : public SequenceWriter {
  public:
    FastaWriter() {}
    explicit FastaWriter(std::ostream &os, bool is_own = false) : SequenceWriter(os, is_own) {}
...
class FastqWriter : public SequenceWriter {
  public:
    explicit FastqWriter(std::ostream &os, bool is_own = false) : SequenceWriter(os, is_own) {}
