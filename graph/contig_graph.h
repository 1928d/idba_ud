...
class ContigGraph {
  public:
    ...
    double IterateComponentCoverage(int min_length, double ratio, double min_cover, double max_cover,
                                    double factor = 1.1, int max_component_size = 30);
    double IterateComponentCoverage2(int min_length, double ratio, double min_cover, double max_cover,
                                     double factor = 1.1, int max_component_size = 30);
    ...
    void SortVertices() {
        std::sort(vertices_.begin(), vertices_.end(), CompareContigLength);
        Refresh();
    }
